...
将知乎故事转化为三条传播文案、精华聊天对话、连续漫画、单图故事卡与可选配乐，并导出完整站外宣传素材包的 AI 工作台。
...
- 同一次文本模型调用在三条传播钩子之外独立提取一段精华对话；支持群聊昵称、私聊备注和居中状态/内心 OS，可导出 1080×1920 手机聊天截图，或按消息数量、文字长度及状态描述自动决定时长的滚动聊天视频。精华对话不作为第四条钩子，也不参与候选排序。
