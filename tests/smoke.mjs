...
assert.equal(restoredProject.analysis.candidates.length,3);
assert.equal(restoredProject.analysis.highlight_dialogue.messages.length,analyzed.highlight_dialogue.messages.length);
